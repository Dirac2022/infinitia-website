...
export function ServiceCard({ index, title, desc, tags, color, icon, iconKey }: ServiceCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className={`service-icon service-icon--${iconKey.toLowerCase()}`}>{icon}</div>
