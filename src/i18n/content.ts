...
export const content: Record<Lang, Content> = {
  es: {
    ...
    hero: {
      ...
      sub: 'Somos un equipo de software enfocado en plataformas web, apps móviles y soluciones de inteligencia de negocio. Del prototipo a la implementación, con la disciplina de un equipo interno.',
    ...
    services: {
      ...
      items: [
        { title: 'Apps móviles', desc: 'Desarrollo en iOS y Android. Desde la arquitectura inicial hasta el despliegue en las tiendas oficiales, bajo los más altos estándares empresariales.', tags: ['Swift', 'Kotlin', 'React Native', 'Expo'], color: '#6C63FF', iconKey: 'Mobile' },
        { title: 'Aplicaciones web', desc: 'Interfaces de alto desempeño enfocadas en la experiencia de usuario. Modernas arquitecturas que garantizan velocidad y disponibilidad global.', tags: ['Next.js', 'React', 'TypeScript', 'Vue'], color: '#00D4FF', iconKey: 'Web' },
        { title: 'Migración a SaaS', desc: 'Tus productos locales hacia un modelo multi-tenant en la nube. Facturación, autenticación y observabilidad integrados. Sin interrupciones.', tags: ['AWS', 'Multi-tenant', 'Stripe', 'Auth0'], color: '#00E5A0', iconKey: 'Cloud' },
    ...
    leadership: {
      ...
      titleB: 'visión clara.',
      lede: 'Profesionales de primera línea. El liderazgo que convierte tecnología en resultados de negocio.',
      members: [
        {
          role: 'Fundador & CEO',
          name: 'Gino Janampa Añaños',
          bio: 'Visionario detrás de Infinitia. Define la dirección estratégica con la convicción de que la tecnología debe estar al servicio del crecimiento real de las empresas. Más de 20 años construyendo productos digitales alrededor del mundo.',
          c1: '#6C63FF',
          c2: '#00D4FF',
        },
        {
  ...
  en: {
    ...
    services: {
      ...
      items: [
        { title: 'Mobile apps', desc: 'Custom iOS and Android development. From initial architecture to app store launch, we deliver enterprise-grade solutions.', tags: ['Swift', 'Kotlin', 'React Native', 'Expo'], color: '#6C63FF', iconKey: 'Mobile' },
        { title: 'Web applications', desc: 'High-performance interfaces focused on user experience. Modern architectures built for speed and global availability.', tags: ['Next.js', 'React', 'TypeScript', 'Vue'], color: '#00D4FF', iconKey: 'Web' },
      ...
      members: [
        {
          role: 'Founder & CEO',
          name: 'Gino Janampa Añaños',
          bio: 'The visionary behind Infinitia. Sets the strategic direction with the conviction that technology must serve real business growth. Over 20 years building digital products across the world.',
          c1: '#6C63FF',
          c2: '#00D4FF',
        },
        {
